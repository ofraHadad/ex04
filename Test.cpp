...
int main() {
	...
	if (signal == 0) {
		...
		.CHECK_EQUAL(smarty.theNumbers,"5688")//the numbers of the chooser need to be 5688
		...
		.CHECK_EQUAL(smarty.theNumbers,"1234")//the numbers of the chooser need to be 5688
